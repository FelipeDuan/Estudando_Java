...
// Aula sobre Udemy.CursoJava.secao08.Objetos
// Udemy.CursoJava.secao08.Objetos:
    /*
...
public class Objetos {
    public static void main(String[] args) {
        ...
        // p1 -> instância do objeto - ou somente "objeto" - da classe Udemy.CursoJava.secao08.Produto
        Produto p1 = new Produto(); // Udemy.CursoJava.secao08.Construtor
        p1.nome = "Notebook";
        p1.preco = 2.367f;
        p1.desconto = 15.0f;
        ...
        p0 = new Produto(); // Udemy.CursoJava.secao08.Construtor
        p0.nome = "Caneta Bic";
        p0.preco = 2.45f;
        p0.desconto = 5;
        ...
        Pessoa pessoa1 = new Pessoa(); // Udemy.CursoJava.secao08.Construtor
