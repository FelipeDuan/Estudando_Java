package Udemy.CursoJava.secao08;// Classes
    /*
        - Nome das classes sempre começa com letras maiúsculas -> Udemy.CursoJava.secao08.Produto
        - Não pode começar com números - Ex: 3Produtos
        - Não pode ter espaço - Ex: Guarda Chuva
        - Não conter caracteres especiais - Ex: Açucar

        Detalhe: Uma Classe Java não possui método Udemy.CursoJava.secao02.Main, diferentemente dos Programas Java
        pois eles apresentam o método Udemy.CursoJava.secao02.Main.
