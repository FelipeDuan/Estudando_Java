...
public class Exe16 {
    public static void main(String[] args) {
        ...
        // Udemy.CursoJava.secao08.Agenda
        Agenda agenda = new Agenda();

        // Armazenando Contatos - void armazenarContato(Udemy.CursoJava.secao08.Contato contato);
        agenda.armazenarContato(contato1);
        agenda.armazenarContato(contato2);
        agenda.armazenarContato(contato3);

        // Imprimindo Udemy.CursoJava.secao08.Agenda - void imprimeAgenda();
        agenda.imprimeAgenda();

        // Imprimindo Udemy.CursoJava.secao08.Contato - void imprimeContato(int index);
        ...
        // Removendo contato - void removeContato(Udemy.CursoJava.secao08.Contato contato);
